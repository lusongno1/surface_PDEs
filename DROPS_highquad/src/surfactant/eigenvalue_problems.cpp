...
#else
    DROPS::SetupInterfaceMassP1HighQuadP1Surf( mg, &M, lset.Phi, lset.GetBndData());
#endif
#endif
...
#else
    DROPS::SetupLBP1HighQuadP1Surf( mg, &A, lset.Phi, lset.GetBndData(), P.get<double>("SurfTransp.Visc"));
#endif
#endif
...
//     }
    ...
    //InterfaceCommonDataP1CL cdatap1( lset.Phi, lset.GetBndData());//store p2 data
...
#else
    InterfaceMatrixAccuCL<LocalMassP2CLHighQuadP1Surf, InterfaceCommonDataP2CL> accuMp2( &Mp2, LocalMassP2CLHighQuadP1Surf(), cdatap2, "Mp2");
    //xxx
#endif
#endif
...
#else
    InterfaceMatrixAccuCL<LocalLaplaceBeltramiP2CLHighQuadP1Surf, InterfaceCommonDataP2CL> accuAp2( &Ap2, LocalLaplaceBeltramiP2CLHighQuadP1Surf( P.get<double>("SurfTransp.Visc")), cdatap2, "Ap2");
#endif // SURFAPPROX
#endif
...
#endif
    exit(0);//for eigenvalue problem, we need only to import mass matrix and stiffness matrix to MATLAB to handle
}
